...
class _ZExpendableItemTileState extends State<ZExpendableItemTile> {
  ...
  Widget _buildListaBatidas() {
    if (widget.exibeBatidas != null &&
        widget.exibeBatidas! &&
        widget.listBatida != null) {
      if (widget.listBatida!.length > 0) {
        return new Container(
            margin: EdgeInsets.only(
              top: (widget.listBatida!.length > 4) ? 6 : 0,
            ),
            height: 30,
        ...
        return new Row(
          ...
          children: <Widget>[
            new Container(
              ...
              child: new Text(
                "SEM BATIDAS",
                style: new TextStyle(color: Color(0xff808080), fontSize: 12),
              ),
            )
          ],
        );
  ...
  Widget _buildExpanded() {
    if (widget.cincoItensExpanded != null && !widget.cincoItensExpanded!) {
      return new Container(
        decoration: BoxDecoration(
            border:
        ...
        child: new Row(
          children: <Widget>[
            new Expanded(
              ...
              onTap: (){
                if(widget.funcaoIconeUm != null){
                  widget.funcaoIconeUm!();
                }
              },
            )),
            new Expanded(
              ...
              onTap: (){
                if(widget.funcaoIconeDois != null){
                  widget.funcaoIconeDois!();
                }
              },
            )),
            new Expanded(
                child: new GestureDetector(
              onTap: (){
                if(widget.funcaoIconeTres != null ){
                  widget.funcaoIconeTres!();
                }
              },
              child: new Container(
                padding: EdgeInsets.only(top: 7.0, bottom: 7.0),
            ...
            new Expanded(
                child: new GestureDetector(
              onTap: (){
                if(widget.funcaoIconeQuatro!=null){
                  widget.funcaoIconeQuatro!();
                }
              },
              child: new Container(
                color: Colors.transparent,
        ...
        child: new Row(
          children: <Widget>[
            ...
            new Expanded(
              ...
              onTap: (){
                if(widget.funcaoIconeCinco != null){
                  widget.funcaoIconeCinco!();
                }
              },
            )),
          ],
                ...
                children: <Widget>[
                  ...
                  new Row(
                    ...
                    children: <Widget>[
                      ...
                      new Text(
                        widget.listBatida![i].horarioBatidaRealizada!,
